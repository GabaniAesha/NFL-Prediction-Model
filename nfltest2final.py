...
# Calculate home and way win percentage when the games were not played in a neutral stadium
home_win = "{:.2f}".format(
...
X_train = train[['over_under_line', 'spread_favorite', 'fav_home', 'hm_avg_pts_diff', 'elo_prob1']]
y_train = train['result']
X_test = test[['over_under_line', 'spread_favorite', 'fav_home', 'hm_avg_pts_diff', 'elo_prob1']]
y_test = test['result']
